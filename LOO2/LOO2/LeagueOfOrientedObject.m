        ...
        while (true)
        {
           ...
           // scanf("%d",&arma);
            ...
            if(arma ==1)
            {
                ...
                j1.vida -=ataqueEfet;
                [batalha addObject:[NSString stringWithFormat:@"%@ leva de %@: %.2f",nomej1,j1.armap, ataqueEfet]];
          ...
          [batalha addObject:[NSString stringWithFormat:@"\np2 Escolha a arma que voce deseja usar: \n1-%@\n2-%@",[j2 armap], [j2 armas]]];
           NSLog(@"\np2 Escolha a arma que voce deseja usar: \n1-%@\n2-%@",[j2 armap], [j2 armas]);
            ...
            else
            {
                ...
                ataqueEfet = [j2 sofreAtaque:ataque];
                j1.vida -=ataqueEfet;
                [batalha addObject:[NSString stringWithFormat:@"%@ leva de %@: %.2f", nomej2,j2.armas,ataqueEfet]];
